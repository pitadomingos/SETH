...
export default function ProjectProposalPage() {
  ...
  const handleContact = () => {
    sessionStorage.setItem('prefillMessage', JSON.stringify({
        subject: `SETH Partnership Inquiry from ${user?.name}`,
        body: `Hello,\n\nOur institution is interested in learning more about the SETH platform. We would like to schedule a personalized demo to see how it can benefit our school.\n\nPlease let us know the next available steps.\n\nThank you,\n${user?.name}`
    }));
      ...
      <main className="container mx-auto px-4 py-12 md:px-6 lg:py-20">
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg text-muted-foreground">
            SETH (Students Excellence Teachers' Hub) is an all-in-one, AI-powered School Management System designed for the unique challenges of modern educational institutions in Southern Africa. We replace administrative burdens with intelligent automation, empowering you to focus on what truly matters: student success.
          </p>
        ...
        <section className="mt-24 grid gap-12 md:grid-cols-2">
            <div className="space-y-4">
             ...
             <div className="space-y-4">
                ...
                <p className="text-muted-foreground">SETH integrates every aspect of school management into a single, intuitive platform. From admissions and finance to academics and parent communication, our AI-driven tools provide actionable insights and streamline daily operations for every user.</p>
            </div>
        </section>
        ...
        <section className="mt-24">
            <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                    SETH is designed with tailored dashboards and tools for every role within your institution.
                </p>
            </div>
        ...
        <section className="mt-24 rounded-lg bg-muted p-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                Let's start a conversation. Schedule a free, no-obligation demo to see how SETH can be tailored to the specific needs of your institution.
            </p>
            <div className="mt-8">
                <Button size="lg" onClick={handleContact}>

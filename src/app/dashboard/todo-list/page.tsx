...
const completedTasks = [
  ...
  'Admin panel for user viewing and system data management (Exam Boards, Fee Descriptions, Event Audiences).',
  'Added Asset Management, Sports, and Reports pages',
  'Added a "School Profile" page for admins with simulated logo upload.',
  ...
  'Made the Reports page dynamic with live quick stats.',

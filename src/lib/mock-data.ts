...
export interface ScheduleSlot { day: string; startTime: string; endTime: string; }
...
export interface SchoolProfile { id: string; name: string; head: string; address: string; phone: string; email: string; motto: string; logoUrl: string; tier?: 'Premium' | 'Pro' | 'Starter'; gradingSystem: '20-Point' | 'GPA' | 'Letter'; }
...
export interface Class { id: string; name: string; grade: string; teacher: string; students: number; room: string; schedule: ScheduleSlot[]; }
...
const northwoodProfile: SchoolProfile = { id: 'northwood', name: 'Northwood High School', head: 'Dr. Sarah Johnson', address: '123 Education Lane, Anytown, USA 12345', phone: '+1 (555) 123-4567', email: 'contact@northwoodhigh.edu', motto: 'Excellence in Education', logoUrl: 'https://placehold.co/100x100.png', tier: 'Starter', gradingSystem: '20-Point', };
const northwoodStudents: Student[] = [ { id: 'S001', name: 'Emma Rodriguez', grade: '10', class: 'A', email: 'e.rodriguez@edumanage.com', phone: '+1 (555) 555-1234', address: '123 Main St, Anytown', parentName: 'Maria Rodriguez', parentEmail: 'm.rodriguez@family.com', status: 'Active' }, { id: 'S002', name: 'James Wilson', grade: '10', class: 'A', email: 'j.wilson@edumanage.com', phone: '+1 (555) 555-5678', address: '456 Oak Ave, Anytown', parentName: 'Robert Wilson', parentEmail: 'r.wilson@family.com', status: 'Active' }, { id: 'S003', name: 'Sofia Kim', grade: '11', class: 'B', email: 's.kim@edumanage.com', phone: '+1 (555) 555-9012', address: '789 Pine Rd, Anytown', parentName: 'Daniel Kim', parentEmail: 'd.kim@family.com', status: 'Active' }, { id: 'S004', name: 'Alex Johnson', grade: '9', class: 'C', email: 'a.johnson@edumanage.com', phone: '+1 (555) 555-3456', address: '321 Elm St, Anytown', parentName: 'Jessica Johnson', parentEmail: 'j.johnson@family.com', status: 'Active' }, { id: 'S005', name: 'Olivia Chen', grade: '12', class: 'A', email: 'o.chen@edumanage.com', phone: '+1 (555) 555-7890', address: '159 Maple Dr, Anytown', parentName: 'Wei Chen', parentEmail: 'w.chen@family.com', status: 'Active' }, { id: 'S006', name: 'Liam Garcia', grade: '9', class: 'A', email: 'l.garcia@edumanage.com', phone: '+1 (555) 555-1122', address: '753 Birch Ln, Anytown', parentName: 'Isabella Garcia', parentEmail: 'i.garcia@family.com', status: 'Active' }, { id: 'S007', name: 'Ava Martinez', grade: '11', class: 'A', email: 'a.martinez@edumanage.com', phone: '+1 (555) 555-3344', address: '951 Cedar Ct, Anytown', parentName: 'David Martinez', parentEmail: 'd.martinez@family.com', status: 'Active' }, { id: 'S008', name: 'Noah Brown', grade: '10', class: 'B', email: 'n.brown@edumanage.com', phone: '+1 (555) 555-5566', address: '852 Spruce Ave, Anytown', parentName: 'Linda Brown', parentEmail: 'l.brown@family.com', status: 'Active' }, { id: 'S009', name: 'Sophia Davis', grade: '9', class: 'B', email: 's.davis@edumanage.com', phone: '+1 (555) 555-7788', address: '147 Walnut St, Anytown', parentName: 'Paul Davis', parentEmail: 'p.davis@family.com', status: 'Active' }, { id: 'S010', name: 'William Miller', grade: '12', class: 'C', email: 'w.miller@edumanage.com', phone: '+1 (555) 555-9999', address: '456 Failure Ave, Anytown', parentName: 'George Miller', parentEmail: 'g.miller@family.com', status: 'Active' }, ];
const northwoodTeachers: Teacher[] = [ { id: 'T001', name: 'Prof. Michael Chen', subject: 'Mathematics', email: 'm.chen@edumanage.com', phone: '+1 (555) 111-2222', address: '123 Calculus Rd, Mathville', experience: '8 years', qualifications: 'Ph.D. in Mathematics', status: 'Active' }, { id: 'T002', name: 'Dr. Lisa Anderson', subject: 'Physics', email: 'l.anderson@edumanage.com', phone: '+1 (555) 222-3333', address: '456 Quantum Way, Physburg', experience: '12 years', qualifications: 'Ph.D. in Physics', status: 'Inactive' }, { id: 'T003', name: 'Ms. Jennifer Davis', subject: 'English', email: 'j.davis@northwood.edu', phone: '+1 (555) 111-3333', address: '101 Literature Lane', experience: '5 years', qualifications: 'M.A. in English', status: 'Active' }, ];
const northwoodClasses: Class[] = [ { id: 'C001', name: 'Class 9-A', grade: '9', teacher: 'Ms. Jennifer Davis', students: 28, room: '101', schedule: [{day: 'Monday', startTime: '09:00', endTime: '10:00'}, {day: 'Wednesday', startTime: '09:00', endTime: '10:00'}, {day: 'Friday', startTime: '09:00', endTime: '10:00'}] }, { id: 'C002', name: 'Class 9-C', grade: '9', teacher: 'Prof. Michael Chen', students: 22, room: '103', schedule: [{day: 'Tuesday', startTime: '10:30', endTime: '12:00'}, {day: 'Thursday', startTime: '10:30', endTime: '12:00'}] }, { id: 'C003', name: 'Class 10-A', grade: '10', teacher: 'Prof. Michael Chen', students: 30, room: '201', schedule: [{day: 'Monday', startTime: '10:00', endTime: '11:00'}, {day: 'Wednesday', startTime: '10:00', endTime: '11:00'}] }, { id: 'C004', name: 'Class 11-B', grade: '11', teacher: 'Dr. Lisa Anderson', students: 25, room: '301', schedule: [{day: 'Tuesday', startTime: '13:00', endTime: '14:30'}] }, ];
...
const oakridgeClasses: Class[] = [ { id: 'C101', name: 'Class 9-B', grade: '9', teacher: 'Mr. Steven Shaw', students: 25, room: 'G1', schedule: [{day: 'Tuesday', startTime: '08:30', endTime: '10:00'}, {day: 'Thursday', startTime: '08:30', endTime: '10:00'}] }, { id: 'C102', name: 'Class 10-A', grade: '10', teacher: 'Ms. Rachel Adams', students: 30, room: 'L1', schedule: [{day: 'Monday', startTime: '11:00', endTime: '12:00'}, {day: 'Wednesday', startTime: '11:00', endTime: '12:00'}] }, ];
...
const maplewoodProfile: SchoolProfile = { id: 'maplewood', name: 'Maplewood International', head: 'Ms. Eleanor Vance', address: '789 Global St, Metropolis, USA 67890', phone: '+1 (555) 456-7890', email: 'info@maplewood.edu', motto: 'Globally Minded, Locally Rooted', logoUrl: 'https://placehold.co/100x100.png', tier: 'Premium', gradingSystem: 'Letter', };
...
const maplewoodClasses: Class[] = [ { id: 'C201', name: 'Class 9-C', grade: '9', teacher: 'Mr. David Lee', students: 22, room: 'H1', schedule: [{day: 'Monday', startTime: '13:00', endTime: '14:30'}, {day: 'Friday', startTime: '13:00', endTime: '14:30'}] }, ];
...
export const schoolData: Record<string, SchoolData> = {
  northwood: {
    ...
    admissions: [ { id: 'ADM001', name: 'John Smith', appliedFor: 'Grade 9', date: '2024-05-10', status: 'Pending', formerSchool: 'Eastwood Elementary', grades: 'A average in all subjects.', parentName: 'Mary Smith', parentEmail: 'm.smith@family.com' }, { id: 'ADM002', name: 'Emily White', appliedFor: 'Grade 10', date: '2024-05-09', status: 'Approved', formerSchool: 'Westwood Middle', grades: 'Excellent academic record, especially in sciences.', parentName: 'David White', parentEmail: 'd.white@family.com' }, ],
  ...
  oakridge: {
    ...
    admissions: [ { id: 'OAK-ADM001', name: 'Alice Wonder', appliedFor: 'Grade 9', date: '2024-05-15', status: 'Approved', formerSchool: 'Wonderland Middle', grades: 'Top of class.', parentName: 'Charles Wonder', parentEmail: 'c.wonder@family.com' }, ],
  ...
  maplewood: {
    ...
    admissions: [ { id: 'MAP-ADM001', name: 'Leo Tolstoy', appliedFor: 'Grade 9', date: '2024-06-01', status: 'Pending', formerSchool: 'Literary Prep', grades: 'Strong in humanities.', parentName: 'Sophia Tolstoy', parentEmail: 's.tolstoy@family.com' }, ],

...
export interface SchoolProfile { id: string; name: string; head: string; address: string; phone: string; email: string; motto: string; logoUrl: string; tier?: 'Premium' | 'Pro' | 'Starter'; gradingSystem: '20-Point' | 'GPA' | 'Letter'; currency: 'USD' | 'ZAR' | 'MZN'; status: 'Active' | 'Suspended' | 'Inactive'; }
export interface Student { id: string; name: string; grade: string; class: string; email: string; phone: string; address: string; schoolId?: string; schoolName?: string; parentName: string; parentEmail: string; dateOfBirth: string; status: 'Active' | 'Inactive' | 'Transferred'; }
...
export interface Admission { id: string; name: string; appliedFor: string; date: string; status: 'Pending' | 'Approved' | 'Rejected'; formerSchool: string; grades: string; parentName: string; parentEmail: string; dateOfBirth: string; }
...
const northwoodProfile: SchoolProfile = { id: 'northwood', name: 'Northwood High School', head: 'Dr. Sarah Johnson', address: '123 Education Lane, Anytown, USA 12345', phone: '+1 (555) 123-4567', email: 'contact@northwoodhigh.edu', motto: 'Excellence in Education', logoUrl: 'https://placehold.co/100x100.png', tier: 'Starter', gradingSystem: '20-Point', currency: 'USD', status: 'Active' };
const northwoodStudents: Student[] = [ { id: 'S001', name: 'Emma Rodriguez', grade: '10', class: 'A', email: 'e.rodriguez@edumanage.com', phone: '+1 (555) 555-1234', address: '123 Main St, Anytown', parentName: 'Maria Rodriguez', parentEmail: 'm.rodriguez@family.com', dateOfBirth: '2008-05-21', status: 'Active' }, { id: 'S002', name: 'James Wilson', grade: '10', class: 'A', email: 'j.wilson@edumanage.com', phone: '+1 (555) 555-5678', address: '456 Oak Ave, Anytown', parentName: 'Robert Wilson', parentEmail: 'r.wilson@family.com', dateOfBirth: '2008-03-15', status: 'Active' }, { id: 'S003', name: 'Sofia Kim', grade: '11', class: 'B', email: 's.kim@edumanage.com', phone: '+1 (555) 555-9012', address: '789 Pine Rd, Anytown', parentName: 'Daniel Kim', parentEmail: 'd.kim@family.com', dateOfBirth: '2007-11-30', status: 'Active' }, { id: 'S004', name: 'Alex Johnson', grade: '9', class: 'C', email: 'a.johnson@edumanage.com', phone: '+1 (555) 555-3456', address: '321 Elm St, Anytown', parentName: 'Jessica Johnson', parentEmail: 'j.johnson@family.com', dateOfBirth: '2009-08-10', status: 'Active' }, { id: 'S005', name: 'Olivia Chen', grade: '12', class: 'A', email: 'o.chen@edumanage.com', phone: '+1 (555) 555-7890', address: '159 Maple Dr, Anytown', parentName: 'Wei Chen', parentEmail: 'w.chen@family.com', dateOfBirth: '2006-01-25', status: 'Active' }, { id: 'S006', name: 'Liam Garcia', grade: '9', class: 'A', email: 'l.garcia@edumanage.com', phone: '+1 (555) 555-1122', address: '753 Birch Ln, Anytown', parentName: 'Isabella Garcia', parentEmail: 'i.garcia@family.com', dateOfBirth: '2009-06-12', status: 'Active' }, { id: 'S007', name: 'Ava Martinez', grade: '11', class: 'A', email: 'a.martinez@edumanage.com', phone: '+1 (555) 555-3344', address: '951 Cedar Ct, Anytown', parentName: 'David Martinez', parentEmail: 'd.martinez@family.com', dateOfBirth: '2007-09-05', status: 'Active' }, { id: 'S008', name: 'Noah Brown', grade: '10', class: 'B', email: 'n.brown@edumanage.com', phone: '+1 (555) 555-5566', address: '852 Spruce Ave, Anytown', parentName: 'Linda Brown', parentEmail: 'l.brown@family.com', dateOfBirth: '2008-07-22', status: 'Active' }, { id: 'S009', name: 'Sophia Davis', grade: '9', class: 'B', email: 's.davis@edumanage.com', phone: '+1 (555) 555-7788', address: '147 Walnut St, Anytown', parentName: 'Paul Davis', parentEmail: 'p.davis@family.com', dateOfBirth: '2009-02-18', status: 'Active' }, { id: 'S010', name: 'William Miller', grade: '12', class: 'C', email: 'w.miller@edumanage.com', phone: '+1 (555) 555-9999', address: '456 Failure Ave, Anytown', parentName: 'George Miller', parentEmail: 'g.miller@family.com', dateOfBirth: '2006-04-01', status: 'Active' }, ];
...
const oakridgeProfile: SchoolProfile = { id: 'oakridge', name: 'Oakridge Academy', head: 'Mr. James Maxwell', address: '456 Knowledge Ave, Learnington, USA 54321', phone: '+1 (555) 987-6543', email: 'admin@oakridgeacademy.edu', motto: 'Wisdom and Integrity', logoUrl: 'https://placehold.co/100x100.png', tier: 'Pro', gradingSystem: 'GPA', currency: 'USD', status: 'Active' };
const oakridgeStudents: Student[] = [ { id: 'S101', name: 'Benjamin Carter', grade: '10', class: 'A', email: 'b.carter@oakridge.com', phone: '+1 (555) 101-1010', address: '1 Apple St', parentName: 'Susan Carter', parentEmail: 's.carter@family.com', dateOfBirth: '2008-10-10', status: 'Active' }, { id: 'S102', name: 'Charlotte Lee', grade: '11', class: 'A', email: 'c.lee@oakridge.com', phone: '+1 (555) 102-1020', address: '2 Pear Ave', parentName: 'John Lee', parentEmail: 'j.lee@family.com', dateOfBirth: '2007-04-14', status: 'Active' }, { id: 'S103', name: 'Daniel Park', grade: '9', class: 'B', email: 'd.park@oakridge.com', phone: '+1 (555) 103-1030', address: '3 Cherry Ln', parentName: 'Grace Park', parentEmail: 'g.park@family.com', dateOfBirth: '2009-12-01', status: 'Transferred' }, { id: 'S104', name: 'Miguel Rodriguez', grade: '9', class: 'B', email: 'm.rodriguez.jr@oakridge.com', phone: '+1 (555) 104-1040', address: '123 Main St, Anytown', parentName: 'Maria Rodriguez', parentEmail: 'm.rodriguez@family.com', dateOfBirth: '2009-09-09', status: 'Active' }, ];
...
const maplewoodProfile: SchoolProfile = { id: 'maplewood', name: 'Maplewood International', head: 'Ms. Eleanor Vance', address: '789 Global St, Metropolis, USA 67890', phone: '+1 (555) 456-7890', email: 'info@maplewood.edu', motto: 'Globally Minded, Locally Rooted', logoUrl: 'https://placehold.co/100x100.png', tier: 'Premium', gradingSystem: 'Letter', currency: 'ZAR', status: 'Active' };
const maplewoodStudents: Student[] = [ { id: 'S201', name: 'Chloe Dubois', grade: '10', class: 'A', email: 'c.dubois@maplewood.com', phone: '+1 (555) 201-2010', address: '1 Eiffel Tower Rd', parentName: 'Amelie Dubois', parentEmail: 'a.dubois@family.com', dateOfBirth: '2008-02-02', status: 'Active' }, { id: 'S202', name: 'Kenji Tanaka', grade: '11', class: 'B', email: 'k.tanaka@maplewood.com', phone: '+1 (555) 202-2020', address: '2 Tokyo Skytree Ave', parentName: 'Haruto Tanaka', parentEmail: 'h.tanaka@family.com', dateOfBirth: '2007-06-19', status: 'Active' }, { id: 'S203', name: 'Priya Singh', grade: '9', class: 'C', email: 'p.singh@maplewood.com', phone: '+1 (555) 203-2030', address: '3 Taj Mahal Blvd', parentName: 'Aarav Singh', parentEmail: 'a.singh@family.com', dateOfBirth: '2009-04-29', status: 'Active' }, { id: 'S204', name: 'Lucas Martinez', grade: '10', class: 'B', email: 'l.martinez@maplewood.com', phone: '+1 (555) 204-2040', address: '4 Berlin Gate', parentName: 'Sofia Martinez', parentEmail: 's.martinez@family.com', dateOfBirth: '2008-11-11', status: 'Active' }, ];

...
export interface Grade { id: string; studentId: string; subject: string; type: 'Coursework' | 'Test' | 'Exam'; description: string; grade: string; date: string; }
...
const teteGrades: Grade[] = [ { id: 'GRD001', studentId: 'S001', subject: 'Matemática', type: 'Test', description: 'Mid-term Exam', grade: '17', date: new Date(now.getFullYear(), now.getMonth() - 2).toISOString() }, { id: 'GRD002', studentId: 'S001', subject: 'Física', type: 'Test', description: 'Mid-term Exam', grade: '16', date: new Date(now.getFullYear(), now.getMonth() - 2).toISOString() }, { id: 'GRD003', studentId: 'S001', subject: 'Português', type: 'Test', description: 'Mid-term Exam', grade: '18', date: new Date(now.getFullYear(), now.getMonth() - 2).toISOString() }, { id: 'GRD004', studentId: 'S002', subject: 'Matemática', type: 'Test', description: 'Mid-term Exam', grade: '14', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() }, { id: 'GRD005', studentId: 'S002', subject: 'Física', type: 'Test', description: 'Mid-term Exam', grade: '14', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() }, { id: 'GRD006', studentId: 'S003', subject: 'Português', type: 'Exam', description: 'Final Exam', grade: '20', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD007', studentId: 'S003', subject: 'Física', type: 'Exam', description: 'Final Exam', grade: '19', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD008', studentId: 'S004', subject: 'Português', type: 'Coursework', description: 'Essay 1', grade: '15', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD009', studentId: 'S005', subject: 'Matemática', type: 'Exam', description: 'Final Exam', grade: '20', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD010', studentId: 'S006', subject: 'Português', type: 'Coursework', description: 'Essay 1', grade: '12', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD011', studentId: 'S007', subject: 'Física', type: 'Exam', description: 'Final Exam', grade: '17', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD012', studentId: 'S008', subject: 'Matemática', type: 'Test', description: 'Mid-term Exam', grade: '15', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD013', studentId: 'S009', subject: 'Português', type: 'Coursework', description: 'Essay 2', grade: '18', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD014', studentId: 'S009', subject: 'Matemática', type: 'Coursework', description: 'Homework 3', grade: '18', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD015', studentId: 'S010', subject: 'Matemática', type: 'Test', description: 'Mid-term Exam', grade: '5', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD016', studentId: 'S010', subject: 'Física', type: 'Test', description: 'Mid-term Exam', grade: '8', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD017', studentId: 'S010', subject: 'Português', type: 'Test', description: 'Mid-term Exam', grade: '8', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, ];
...
const championGrades: Grade[] = [ { id: 'GRD101', studentId: 'S101', subject: 'Biologia', type: 'Coursework', description: 'Lab Report', grade: '18', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() }, { id: 'GRD102', studentId: 'S102', subject: 'Geografia', type: 'Test', description: 'Map Quiz', grade: '15', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() }, { id: 'GRD103', studentId: 'S104', subject: 'Geografia', type: 'Test', description: 'Map Quiz', grade: '14', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, { id: 'GRD104', studentId: 'S104', subject: 'Biologia', type: 'Coursework', description: 'Lab Report', grade: '12', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, ];
...
const miniarteGrades: Grade[] = [ { id: 'GRD201', studentId: 'S201', subject: 'História', type: 'Coursework', description: 'Research Paper', grade: '18', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() }, { id: 'GRD202', studentId: 'S204', subject: 'História', type: 'Coursework', description: 'Presentation', grade: '15', date: new Date(now.getFullYear(), now.getMonth()).toISOString() }, ];
...
const beiraGrades: Grade[] = [
    { id: 'GRD301', studentId: 'S301', subject: 'Artes', type: 'Coursework', description: 'Painting Project', grade: '19', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() },
    { id: 'GRD302', studentId: 'S302', subject: 'Música', type: 'Test', description: 'Theory Test', grade: '17', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() },
];
...
const nampulaGrades: Grade[] = [
    { id: 'GRD401', studentId: 'S401', subject: 'Teatro', type: 'Coursework', description: 'Monologue Performance', grade: '16', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() },
    { id: 'GRD402', studentId: 'S402', subject: 'Dança', type: 'Test', description: 'Choreography Test', grade: '18', date: new Date(now.getFullYear(), now.getMonth() - 1).toISOString() },
];

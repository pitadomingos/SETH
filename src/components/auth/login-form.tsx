...
const formSchema = z.object({
  ...
  role: z.enum(['GlobalAdmin', 'PremiumAdmin', 'Admin', 'Teacher', 'Student', 'Parent'], { required_error: 'You must select a role.' }),
});
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="PremiumAdmin">Group Administrator (Premium)</SelectItem>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <div className="text-center text-sm text-muted-foreground">
              ...
              <p><span className="font-semibold">Group Admin (Premium):</span> `admin4`</p>
